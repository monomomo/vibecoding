    ...
    <section id="contact" className="py-16 px-6 bg-white border-t border-gray-100">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-gray-50 rounded p-6 md:p-8 border border-gray-200">
            <h3 className="text-sm font-semibold text-gray-900 mb-5 tracking-wide uppercase">
              基本信息
            </h3>
            <div className="space-y-4">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${contact.email}`} className="text-sm text-gray-700 hover:text-gray-900 transition-colors">
                    {contact.email}
                  </a>
                </div>
              </div>
            ...
            <div className="space-y-3">
              {contact.socialLinks.map((link, index) => (
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded border border-gray-200 hover:border-gray-300 hover:bg-white transition-all"
                >
                  {link.icon === 'github' && (
